...
- ☁️ Supporto foto da GitHub, Azure Blob, o locale
...
## ⚠️ IMPORTANTE: Problema CORS con OneDrive

**OneDrive NON funziona** per embeddare foto in app web a causa di restrizioni CORS, anche con link "diretti".

### ✅ Soluzioni Consigliate

1. **GitHub** (FACILE - 5 minuti) - [📖 Guida Completa](docs/GITHUB_SETUP.md)
   - Gratis fino a 1GB
   - Zero problemi CORS
   - Setup immediato

2. **Azure Blob Storage** (PROFESSIONALE) - [📖 Guida Completa](docs/AZURE_BLOB_SETUP.md)
   - Scalabile e veloce
   - Costo minimo (~€0.17/mese per 10GB)
...
### ❌ NON Funzionano
- OneDrive (CORS bloccato)
- Google Drive link pubblici (CORS bloccato)
- Dropbox link di condivisione (CORS bloccato)

**Vedi [docs/ONEDRIVE_LINKS_GUIDE.md](docs/ONEDRIVE_LINKS_GUIDE.md) per dettagli sul perché OneDrive non funziona.**
